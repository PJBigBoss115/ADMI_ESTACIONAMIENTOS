...
import admi_estacionamientos.FXMLVista_3Controller;
...
public class ValidacionesEtc {
    ...
    public int enviaValido;
    public int enviaInfo;
    int longuitudX;
    int i;
    char caracterX;
    char evaluaX;
    
    static public double tiempoUtilizado;
    static public double totalCancelar;
    static public double periodosT;
    static public double totalDescuento;
    static public double extra;
    ...
    public void GenerarFactura(String x0, String x1, String x2, String x3, String x4, String x5, String x6){
        try{
        ...
        String escribe;
            ...
            nuevoPDF.save("C:\\Users\\pedro\\Documents\\NetBeansProjects\\ADMI_ESTACIONAMIENTOS\\Factura"+x6+".pdf");
        }catch(Exception e){
    ...
    public void GenerarTicket(String x0, String x1, String x2, String x3, String x4){
        ...
        String escribe;
            ...
            nuevoPDF.save("C:\\Users\\pedro\\Documents\\NetBeansProjects\\ADMI_ESTACIONAMIENTOS\\Ticket"+x1+".pdf");
        }catch(Exception e){
            System.out.println("Error: Algo inesperado a sucedido......");
        }
    }
